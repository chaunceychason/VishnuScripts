...
def plotMAtree3( scale1, mass1, spinarray1, half_formationscale, plotfunc_count):
	...
	x_axis="scale time"
	y_axis="total spin"
	figure_name=os.path.expanduser('~/Jan19TOTALSpinAccretionfigure' +'.png')
	#Choose which type of plot you would like: Commented out.
...
def plotMAtreeFINALhist( scale1, mass1, Vmaxarray, SpinarrayTOT,plotfunc_count):
	...
	x_axis="scale time"
	y_axis="total mass"
	figure_name=os.path.expanduser('~/Jan19HISTMassAccretionfigureSPIN' +'.png')
	#Choose which type of plot you would like: Commented out.
	...
	plt.hist2d(scale1, SpinarrayTOT, (100, 500), cmap=plt.cm.jet, norm=matplotlib.colors.LogNorm() )
